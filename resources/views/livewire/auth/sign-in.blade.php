                    ...
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0"> {{__('You can log in with 3 user types:')}}
                                <p class="mb-0">{{__('1. Email: ')}}<strong>{{__('admin@argon.com')}}</strong>
                                    {{__('Password')}}
                                    <strong>{{__('secret')}}</strong></p>
                                <p class="mb-0">{{__('2. Email:')}} <strong>{{__('creator@argon.com')}}</strong>
                                    {{__('Password')}}
                                    <strong>{{__('secret')}}</strong></p>
                                <p class="mb-0">
                                    {{__('3. Email: ')}}<strong>{{__('member@argon.com')}}</strong>{{__(' Password')}}
                                    <strong>{{__('secret')}}</strong></p>
                            </p>
                        </div>
